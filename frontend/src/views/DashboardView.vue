        ...
        <div v-else-if="authStore.isMahasiswa">
          ...
          <div class="card">
            ...
            <div v-if="!stats.recentActivity?.length" class="py-12 text-center">
              ...
              <router-link to="/upload" class="btn-primary inline-flex mt-4 text-xs">Mulai Latihan</router-link>
            </div>

            <table v-else class="data-table">
              <thead>
                <tr>
                  <th>Judul</th><th>Tanggal</th><th>Skor</th><th></th>
                </tr>
              </thead>
              <tbody>
                <tr v-for="item in stats.recentActivity" :key="item.id">
                  ...
                  <td>
                    <span v-if="item.score !== null" class="font-bold">{{ item.score.toFixed(1) }}</span>
        ...
        <div v-else>
          ...
          <div class="card">
            ...
            <table class="data-table">
              <thead>
                <tr>
                  <th>Nama</th><th>NIM</th><th>Total Latihan</th><th>Skor Terakhir</th><th>Rata-rata</th>
                </tr>
              </thead>
              <tbody>
...
const classAverage = computed(() => {
  const scores = dosenStats.value.map((s) => s.averageScore).filter((s) => s !== null)
